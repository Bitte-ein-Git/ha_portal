...
function renderBadge({ width, height, accessibleText }, main) {
  ...
  <rect width="${width}" height="${height}" rx="${height / 2}" fill="#FE7500"/>
  ${main}
  <g style="transform: translate(${width - 497}px, 0);">
      <rect x="344" y="16" width="137" height="64" rx="32" fill="#F2F4F9"/>
      <path d="M394.419 37.0469V60.5H390.122V46.7969L384.716 60.5H380.559L375.216 46.9062V60.5H371.028V37.0469H375.216L382.638 55.4062L390.122 37.0469H394.419ZM403.784 37.0469L409.128 46.9375L414.472 37.0469H419.238L411.269 51.1875V60.5H406.878V51.1875L398.847 37.0469H403.784Z" fill="#FE7500"/>
      <g>
          <path d="M457 60C457 61.65 455.65 63 454 63H430C428.35 63 427 61.65 427 60V51C427 49.35 427.95 47.05 429.12 45.88L439.88 35.12C441.05 33.95 442.96 33.95 444.12 35.12L454.88 45.88C456.05 47.05 457 49.35 457 51V60Z" fill="#FE7500"/>
